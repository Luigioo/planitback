...
insert into plan (name, user_id, start, end, allday) values('walk', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, false);
...
insert into task (name, user_id, duration, start) values('feed cat', 1, 3600, '2020-1-30 22:11:11');
insert into my_user (name, password, enabled, locked, role)
